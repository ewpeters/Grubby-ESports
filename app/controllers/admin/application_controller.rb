class Admin::ApplicationController < ApplicationController
  ...
  private
    ...
    def find_sections
      @sections = ["categories", "forums", "users", "groups", "ranks", "themes", "configurations", "tickers", "features", "articles", "events", "downloads", "tvs", "albums", "logos", "statuses"].select do |name|
