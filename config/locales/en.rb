{
  :'en' => {
   ...
   :Administration_Section => "Forum Administration Section",
   ...
   :can_manage_tickers? => "Can manage tickers?",
   :can_manage_features? => "Can manage features?",
   ...
   :can_manage_configurations? => "Can manage configs?",
   :can_manage_reports? => "Can manage reports?",
   :can_manage_banned_users? => "Can manage bans?",
   :can_manage_banned_ips? => "Can manage ips?",
   ...
   :Content_Section => "Content Administration Section",
   :Create => "Create",
